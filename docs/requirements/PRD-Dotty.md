...
<!-- BUILD-HTML-PROMPT
{
  ...
  "mood": "clean",
  "format": "screen",
  "notes": "PRD for a SaaS AI assistant. Contains tables, code samples, architecture diagrams described in text, and structured decision tables. Rendered as a clean technical reference document."
}
```
...
```bash
build-html docs/requirements/PRD-Dotty.md
```

Or ask: `@docs/requirements/PRD-Dotty.md follow the html build instructions`
